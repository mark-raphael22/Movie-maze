...
export default function MediaCard({id, image, genres, name},{data,error,loading}) {
  return (
    <Link to={`/tvshows/${id}`}>
      <div className="me-4  MediaCard position-relative border-bottom-0 " style={{width: '80vw', height: '350px '}}>
      {loading&&<Spinner/>}
